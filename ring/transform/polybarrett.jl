struct ReductorArbNTT
    ...
    A::Int64
    ñ::Int64
    ntterñ::CyclicTransformer2a3b5c7d
    ntterA::CyclicTransformer2a3b5c7d
    poly::Vector{UInt64}
    ...
    @views function ReductorArbNTT(deg::Int64, poly::Vector{Int64}, Q::Modulus)
        ...
        ntterñ = CyclicTransformer2a3b5c7d(ñ, Q)
        ntterA = CyclicTransformer2a3b5c7d(A, Q)
...
struct ReductorCycloNTT
    ...
    A::Int64
    ñ::Int64
    ntterñ::Union{CyclicTransformer2a3b5c7d,Missing}
    ntterA::Union{CyclicTransformer2a3b5c7d,Missing}
    poly::Vector{UInt64}
    Xdeg_over_poly::Vector{UInt64}
    fbuff::Vector{UInt64}
    rbuff::Vector{UInt64}
...
struct ReductorArbWord
    ...
    ñ::Int64
    beP2Q::BasisExtender
    ntterñ::Vector{CyclicTransformer2a3b5c7d}
    ntterA::Vector{CyclicTransformer2a3b5c7d}
    ...
    @views function ReductorArbWord(deg::Int64, poly::Vector{Int64}, Q::Modulus)
        ...
        ntterñ = CyclicTransformer2a3b5c7d[CyclicTransformer2a3b5c7d(ñ, Pi) for Pi = P]
        ntterA = CyclicTransformer2a3b5c7d[CyclicTransformer2a3b5c7d(A, Pi) for Pi = P]
...
struct ReductorCycloWord
    ...
    function ReductorCycloWord(m::Int64, Q::Modulus)
        ...
        if deg == N
            new(p, moverp, true, m, deg, N, Q, 0, Modulus[], 0, 0, 0, missing, CyclicTransformer2a3b5c7d[], CyclicTransformer2a3b5c7d[], Vector{UInt64}[], Vector{UInt64}[], Vector{UInt64}[], Vector{UInt64}[], Vector{UInt64}[])
        else
            ñ = next2a3b5c7d(N)
            α = deg - N
            A = next2a3b5c7d(2α + 1)
