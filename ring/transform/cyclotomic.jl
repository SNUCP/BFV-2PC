struct CyclotomicTransformerPow2
    Q::Modulus
    m::Int64
    N::Int64
    N⁻¹::UInt64
    ...
    function CyclotomicTransformerPow2(m::Int64, Q::Modulus)
...
@views _ntt!(a::AbstractVector{UInt64}, ntter::CyclotomicTransformerPow2) = begin
...
@views _ntt_to!(res::AbstractVector{UInt64}, a::AbstractVector{UInt64}, ntter::CyclotomicTransformerPow2) = begin
...
@views _intt!(a::AbstractVector{UInt64}, ntter::CyclotomicTransformerPow2) = begin
...
@views _intt_to!(res::AbstractVector{UInt64}, a::AbstractVector{UInt64}, ntter::CyclotomicTransformerPow2) = begin
    @inbounds @simd for i = eachindex(res)
        res[i] = a[i]
    end
    _intt!(res, ntter)
...
struct CyclotomicTransformerArb
    Q::Modulus
    m::Int64
    N::Int64
    ntter::CyclicTransformerBluestein
    ...
    function CyclotomicTransformerArb(m::Int64, Q::Modulus)
        ...
        ntter = CyclicTransformerBluestein(m, Q)
...
# Bluestein NTT
@views function _ntt!(a::AbstractVector{UInt64}, ntter::CyclotomicTransformerArb)
    @. ntter.buff = UInt64(0)
...
@views _ntt_to!(res::AbstractVector{UInt64}, a::AbstractVector{UInt64}, ntter::CyclotomicTransformerArb) = begin
    @inbounds @simd for i = eachindex(res)
        res[i] = a[i]
    end
    _ntt!(res, ntter)
...
# Bluestein iNTT
@views function _intt!(a::AbstractVector{UInt64}, ntter::CyclotomicTransformerArb, islazy::Bool=false)
    @. ntter.buff = 0
    @inbounds @simd for i = 1:ntter.N
...
@views _intt_to!(res::AbstractVector{UInt64}, a::AbstractVector{UInt64}, ntter::CyclotomicTransformerArb, islazy::Bool=false) = begin
    @inbounds @simd for i = eachindex(res)
        res[i] = a[i]
    end
...
const CyclotomicTransformer = Union{CyclotomicTransformerPow2,CyclotomicTransformerArb}

(::Type{CyclotomicTransformer})(m::Int64, Q::Modulus) =
    ispow2(m) ? CyclotomicTransformerPow2(m, Q) : CyclotomicTransformerArb(m, Q)